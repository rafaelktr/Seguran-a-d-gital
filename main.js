...
document.addEventListener('DOMContentLoaded', () => {
    const perguntas = [
        ...
        {
            enunciado: "Você entra na caverna e decide explorar a figura. O que faz?",
            alternativas: [
                {
                    texto: "Aproxima-se da figura.",
                    historia: "Você se aproxima e descobre que é uma sombra projetada. No entanto, você sente uma presença ameaçadora. Você decide continuar explorando ou voltar para a floresta?",
                    proxima: 5,
                },
                {
                    texto: "Volta para a floresta.",
                    historia: "Você retorna para a floresta e encontra um rio. O que faz?",
                    proxima: 6,
                },
            ]
        },
    ...
    function respostaSelecionada(opcaoSelecionada) {
        ...
        botaoContinuar.addEventListener("click", continuaPergunta);
