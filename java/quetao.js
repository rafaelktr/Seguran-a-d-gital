export const perguntas = [
    ...
    {
    texto: "Explora a cabana.",
    afirmacao: "Dentro da cabana, você encontra um mapa que leva à ponte. O que faz?",
    proxima: 29,
    },
    {
    texto: "Ignora a cabana.",
    afirmacao: "Você continua explorando e encontra uma clareira. O que faz?",
    proxima: 30,
    },
    ]
    },
    ...
    afirmacao: "Você explora a clareira e encontra uma ponte. O que faz?",
    proxima: 31,
    },
    {
    ...
    afirmacao: "Você enfrenta a figura e descobre que era sua imaginação. Você encontra uma saída para a floresta. O que faz?",
    proxima: 33,
    },
    {
    texto: "Volta para a passagem subterrânea.",
    afirmacao: "Você volta para a passagem e encontra uma nova saída. O que faz?",
    proxima: 34,
    },
    ]
    },
    ...
    {
    texto: "Segue o mapa.",
    afirmacao: "Você segue o mapa e encontra uma ponte. O que faz?",
    proxima: 35,
    },
    {
    texto: "Ignora o mapa e explora mais a cabana.",
    afirmacao: "Você explora mais a cabana e encontra uma saída para a floresta. O que faz?",
    proxima: 36,
    },
    ]
    },
    ...
    afirmacao: "Dentro da cabana, você encontra uma pista para a ponte. O que faz?",
    proxima: 37,
    },
    {
    texto: "Ignora a cabana e segue o campo.",
    afirmacao: "Você continua pelo campo e encontra uma clareira. O que faz?",
    proxima: 38,
    },
    ]
    },
    ...
    afirmacao: "Você volta para a clareira e encontra um caminho de volta para a floresta.",
    ...
    afirmacao: "Você segue pela nova saída e encontra uma ponte. O que faz?",
    proxima: 39,
    },
    {
    texto: "Explora mais a passagem.",
    ...
    afirmacao: "Você volta para o mapa e encontra uma nova direção para seguir.",
    ...
    afirmacao: "Você explora mais a área e encontra uma clareira. O que faz?",
    proxima: 42,
    },
    ]
    },
    ...
    afirmacao: "Você volta ao início e precisa começar novamente.",
    ...
    afirmacao: "Você volta para a entrada da caverna e encontra uma nova direção para seguir.",
    ...
    afirmacao: "Você segue a nova direção e encontra uma ponte. O que faz?",
    proxima: 45,
    },
    {
    texto: "Ignora a nova direção e continua explorando.",
    afirmacao: "Você continua explorando e se perde novamente.",
